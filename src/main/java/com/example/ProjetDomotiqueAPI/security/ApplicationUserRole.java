...
public enum ApplicationUserRole {
    ...
    ADMIN(Sets.newHashSet(UTILISATEUR_READ,APPAREIL_READ,APPAREIL_WRITE,AUTORISATION_READ,AUTORISATION_WRITE,DONNEE_READ,DONNEE_REF_READ,DONNEE_REF_WRITE,PIECE_READ,PIECE_WRITE)),
